        ...
        steps.append(
            PipelineStepResult(
                ...
                artifacts=[
                    ...
                    str(playtest_dir / "lab-access-bundle.md"),
                    str(playtest_dir / "lab-access-bundle.json"),
                    ...
                    str(playtest_dir / "solver-run" / "solver-run.md"),
                    str(playtest_dir / "solver-run" / "solver-run.yaml"),
