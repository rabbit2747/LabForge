...
def isolate_generated_state(module: Any, service: str) -> None:
    ...
    patches = {
        ...
        "IDOR_AUDIT_PATH": state / "object-access-audit.json",
        "DOCUMENT_ROOT": state / "documents",
        "DOCUMENT_AUDIT_PATH": state / "document-access-audit.json",
        "UPLOAD_ROOT": state / "uploads",
        "UPLOAD_REVIEW_PATH": state / "upload-review-queue.json",
        "UPLOAD_ACCESS_AUDIT_PATH": state / "upload-access-audit.json",
        "SSRF_AUDIT_PATH": state / "ssrf-fetch-audit.json",
        "DIAGNOSTIC_AUDIT_PATH": state / "diagnostic-command-injection-audit.json",
        "CREDENTIAL_ACCESS_AUDIT_PATH": state / "credential-exposure-access-audit.json",
