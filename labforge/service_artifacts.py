...
def render_runtime_dockerfile(artifact, port: int) -> str:
    return "\n".join(
        [
            ...
            "RUN mkdir -p /home/attacker /var/log/labforge && chmod -R 755 /app /home/attacker /var/log/labforge && chmod +x /usr/local/bin/labforge-healthcheck /usr/local/bin/labforge-reset",
            f"EXPOSE {port}",
