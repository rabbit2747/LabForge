    ...
    return {
        ...
        "app.py": "\n".join(
            [
                ...
                "@app.get('/')",
                "def index():",
                "    return jsonify({'service': SERVICE, 'purpose': PURPOSE, 'endpoints': ['/', '/metadata', '/workflow', '/api/chain', '/api/stages/<stage_id>', '/healthz']})",
                "",
                "",
                "@app.get('/metadata')",
                "def metadata_route():",
    ...
    return {
        ...
        "app.py": "\n".join(
            [
                ...
                "    return render_template_string(DASHBOARD_TEMPLATE, service=SERVICE, role=ROLE, purpose=PURPOSE, metadata=metadata, routes=ROUTES, workflow=workflow, records=records, clues=clues, chain=chain, events=events)",
                "",
                "",
                "@app.get('/metadata')",
                "def metadata():",
                ...
                "  </header>",
                "  <nav><a class=\"active\" href=\"/\">Overview</a><a href=\"/workflow\">Workflow</a><a href=\"/api/records\">Records API</a><a href=\"/api/chain\">Chain Context</a><a href=\"/logs/events\">Events</a><a href=\"/api/routes\">Routes</a></nav>",
                "  <main>",
                "    <div>",
