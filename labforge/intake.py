...
def securities_profile(request: NaturalLanguageScenarioRequest) -> dict:
    return {
        ...
        "stages": [
            ...
            stage("stage-02", "Establish a bounded foothold in the application tier.", "Use the investor-portal entry weakness to collect service identity, environment, and internal routing context without touching real financial systems.", "Execution", ["T1059 Command and Scripting Interpreter"], ["investor-portal", "attacker-workstation"]),
...
def banking_profile(request: NaturalLanguageScenarioRequest) -> dict:
    return {
        ...
        "stages": [
            ...
            stage("stage-02", "Establish a bounded foothold in the digital banking tier.", "Use the loan-application-portal entry weakness to collect service identity, environment, and internal routing context without touching real banking systems.", "Execution", ["T1059 Command and Scripting Interpreter"], ["loan-application-portal", "attacker-workstation"]),
...
def manufacturing_profile(request: NaturalLanguageScenarioRequest) -> dict:
    return {
        ...
        "stages": [
            ...
            stage("stage-05", "Discover bounded production services.", "Use engineering maintenance notes and host records to identify MES, historian, and jump-host surfaces that support production operations.", "Discovery", ["T1046 Network Service Discovery"], ["mes-api", "historian", "ot-jump-host"]),
...
def generic_stage_chain(entry: str, internal: str, final: str) -> list[dict]:
    return [
        ...
        stage("stage-02", "Establish a bounded foothold.", f"Use the {entry} entry weakness to obtain lab-scoped execution or session access.", "Execution", ["T1059 Command and Scripting Interpreter"], [entry, "attacker-workstation"]),
